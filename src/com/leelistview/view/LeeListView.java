...
public class LeeListView extends RelativeLayout implements OnScrollListener{
	...
	private boolean mIsAnimation = false; //榛樿涓篺alse
	private Animation animationDown = null; //鍚戜笂鍔ㄧ敾
	private Animation animationUp = null; //涓嬫媺鍔ㄧ敾
	private TextView infoHint = null; //寮瑰嚭鐨勯偅涓猼extview
	private String count = "0"; //琛ㄧず鏇存柊浜嗗灏戞潯
	...
	public void onFresh(){
		...
		resetHeaderHeight();
		int finalHeight = DensityUtil.dip2px(context, 60);  //XListViewHeader涓殑楂樺害
